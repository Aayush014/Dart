class bank {
  ...
  bank._temp(this.isActive, this.balance, this.age, this.eyeColor, this.name,
      this.gender, this.company, this.email, this.phone, this.address);
      
  factory bank.formMap(Map m1) {
    ...
    return bank._temp(isActive, balance, age, eyeColor, name, gender,
